"""Metrics Brain — weekly analyser for the Minds memory system.
...
def write_report(weekly, matched):
    ...
    lines = [f"# Minds Metrics Report — {now}", ""]
    ...
    lines.append("")
    lines.append("---")
    lines.append("*Generated by Minds metrics-brain. Read `starter-kit/README.md` for what these numbers mean.*")
