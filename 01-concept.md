...
**Minds** sits between OpenClaude and a human mind. It's the next evolution: **AI that remembers like a colleague**.
...
Minds implements that loop in the smallest possible form:
...
This research folder is the **generic, portable kernel** of the Minds idea. Not a framework. Not a SaaS. A small set of files you can drop into any Claude Code project plus a setup wizard that personalises them to you.
