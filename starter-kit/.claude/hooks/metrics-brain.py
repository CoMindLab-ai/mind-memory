"""Metrics Brain — weekly analyser for the CognitiveMemory memory system.
...
def write_report(weekly, matched):
    ...
    lines = [f"# CognitiveMemory Metrics Report — {now}", ""]
    ...
    lines.append("")
    lines.append("---")
    lines.append("*Generated by CognitiveMemory metrics-brain. Read `starter-kit/README.md` for what these numbers mean.*")
